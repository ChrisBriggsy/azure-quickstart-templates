...
mkdir plugins
cd plugins
wget --http://scriptcraftjs.org/download/latest/scriptcraft-3.1.10/scriptcraft.jar;
cd ../
# download the server jar
while ! echo y | wget --no-check-certificate https://canarymod.net/releases/CanaryMod-1.8.0-1.2.0-RC1.jar; do
    sleep 10
    wget --no-check-certificate  https://canarymod.net/releases/CanaryMod-1.8.0-1.2.0-RC1.jar;
done
